...
public class BmpCompressUtils {
     ...
     * @return
     */
    public static byte[] getBytesByBitmap(Bitmap bitmap, int quality, Bitmap.CompressFormat fmt) {
        ByteArrayOutputStream outputStream = new ByteArrayOutputStream(bitmap.getByteCount());
        bitmap.compress(fmt, quality, outputStream);
